...
template < class T > struct FftwMallocator {
    typedef T value_type;

    FftwMallocator( ) = default;
    template < class U >
    constexpr FftwMallocator( const FftwMallocator< U > & ) noexcept {}
...
bool operator==( const FftwMallocator< T > &, const FftwMallocator< U > & ) {
    return true;
}
template < class T, class U >
bool operator!=( const FftwMallocator< T > &, const FftwMallocator< U > & ) {
