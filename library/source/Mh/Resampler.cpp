...
{
	pimpl = uSimpleResamplerImpl((cpy.pimpl) ? new SimpleResamplerImpl(*cpy.pimpl) : nullptr);
}
...
{
	pimpl = uFullResamplerImpl((cpy.pimpl) ? new FullResamplerImpl(*cpy.pimpl) : nullptr);
}
